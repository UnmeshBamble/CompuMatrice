...
<body>
    ...
    <div>
        ...
        <asp:TextBox ID="TextBox1" runat="server" Height="22px" ></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="SomeName" ErrorMessage="Product name cannot be left empty!" ControlToValidate="TextBox1" ForeColor="Red"></asp:RequiredFieldValidator>
        <br />
         <br />
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" InitialValue="0" ValidationGroup="SomeName" ErrorMessage="Please select a category!" ControlToValidate="DropDownList1" ForeColor="Red"></asp:RequiredFieldValidator>
        <br />
        <br />
            <asp:Label ID="Label3" runat="server" Text="Quantity :" ></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="TextBox3" runat="server" Height="22px" ></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Quantity cannot be left empty!" ControlToValidate="TextBox3" ValidationGroup="SomeName" ForeColor="Red"></asp:RequiredFieldValidator>
      ...
      ValidationExpression="^\d+$" ForeColor="Red"></asp:RegularExpressionValidator>
       ...
       <br />
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Price cannot be left empty!" ControlToValidate="TextBox4" ValidationGroup="SomeName" ForeColor="Red"></asp:RequiredFieldValidator>
      ...
      ValidationExpression="^\d+$" ForeColor="Red"></asp:RegularExpressionValidator>
       ...
       <br />
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Please enter product description!" ControlToValidate="TextBox5" ValidationGroup="SomeName" ForeColor="Red"></asp:RequiredFieldValidator>
         <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <br />
            <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button1" runat="server" Text="Submit" OnClick="btn_Submit" ValidationGroup="SomeName"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button2" runat="server" Text="Reset" OnClick="btn_Reset" CausesValidation="False" Height="26px" Width="61px" ValidationGroup="SomeName"/>
            <br />
      </div>
        <br />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ProductConnStr %>" DeleteCommand="DELETE FROM [tblProducts] WHERE [productId] = @productId" InsertCommand="INSERT INTO [tblProducts] ([productId], [ProductName], [ProductCategory], [Quantity], [Price], [ProductDescription]) VALUES (@productId, @ProductName, @ProductCategory, @Quantity, @Price, @ProductDescription)" SelectCommand="SELECT * FROM [tblProducts]" UpdateCommand="UPDATE [tblProducts] SET [ProductName] = @ProductName, [ProductCategory] = @ProductCategory, [Quantity] = @Quantity, [Price] = @Price, [ProductDescription] = @ProductDescription WHERE [productId] = @productId">
            <DeleteParameters>
